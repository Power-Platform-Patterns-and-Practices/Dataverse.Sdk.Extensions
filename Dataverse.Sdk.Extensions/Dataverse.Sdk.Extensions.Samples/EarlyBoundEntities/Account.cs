...
namespace Dataverse.Sdk.Extensions.Samples.EarlyBoundEntities
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Tbs.Xrm.EntityWrappers.AccountState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Tbs.Xrm.EntityWrappers.AccountState)(System.Enum.ToObject(typeof(Tbs.Xrm.EntityWrappers.AccountState), optionSet.Value)));
				}
				else
				{
					return null;
